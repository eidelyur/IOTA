...
#
# File 'rssynergia_example_notebook.ipynb' from directory
...
#    basicdiag = synergia.bunch.Diagnostics_basic("basic.h5", optsCrrnt.output_dir)
...
#    fulldiag = synergia.bunch.Diagnostics_full2("full2.h5", optsCrrnt.output_dir)
...
#    particlediag = synergia.bunch.Diagnostics_particles("particles.h5",0,0,optsCrrnt.output_dir)
