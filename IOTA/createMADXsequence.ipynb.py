...
testNLI = NonlinearInsert(l0, mu0, cval, tval)
testN = generate_sequence(testNLI)
create_madx(testNLI)
...
testNLIn = NonlinearInsert(l0, mu0, cval, tval, slices)
testNn = generate_sequence(testNLIn)
create_madx(testNLIn)

old = create_madx(testNLI)
old

new = create_madx(testNLIn)
new
